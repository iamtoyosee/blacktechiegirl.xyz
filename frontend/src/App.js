...
function App() {
  ...
  return (
    <div className="App ">
      <Navbar />
      <div className='h-[300px] md:h-[500px] lg:h-[800px]  xl:h-[750px] bg-black flex justify-center items-center px-2'>
        <h1 className='font-bignote text-[45px] md:text-[85px] lg:text-[125px] 2xl:max-w-[60%]   lg:leading-[150px] text-white text-left font-bold'>I AM THAT BLACK TECHIE GIRL</h1>
      </div>
      ...
      <>
        ...
        >
          <div>
            ...
            <h1 className=" font-bigtech text-left  text-[30px] md:text-[50px] py-4">Toyosi Usman is a <br></br>
