    ...
    return (
        <div>
            ...
            <div className="max-w-screen-xl  mx-auto py-10">
                ...
                <h1 className="font-bignote text-[60px] font-bold ">Divide and Conquer Algorithms with Python Examples</h1>
                <div>
                    ...
                    <img
                        src={Proto1}
                        alt="product "
                        className="h-[600px] mb-10 w-full object-cover object-top cursor-pointer "
                    />

                </div>

                <div className="font-lvreg text-2xl">
                    ...
                    <p>What Is Divide and Conquer? &#55356;&#57102; Divide and conquer is where you divide a large problem up into many smaller, much easier-to-solve problems. The rather small example below illustrates this.</p>

                    <p>What Is Divide and Conquer? &#55356;&#57102; Divide and conquer is where you divide a large problem up into many smaller, much easier-to-solve problems. The rather small example below illustrates this.</p>

                    <p>3+6+2+4 is divided into 3+6 and 2+4 We take the equation &ldquo;3 + 6 + 2 + 4&rdquo; and cut it down into the smallest set of equations, which is [3 + 6, 2 + 4]. It could also be [2 + 3, 4 + 6]. The order doesn&rsquo;t matter, as long as we turn this one long equation into many smaller equations.</p>

                    <p>Let&rsquo;s say we have 8 numbers:</p>
                    ...
                    <p> We then add 2 numbers at a time.</p>
                    ...
                    <p>A divide and conquer algorithm tries to break a problem down into as many little chunks as possible since it is easier to solve with little chunks. It does this with recursion.</p>
                </div>
            </div>
